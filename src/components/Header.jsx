...
function Header() {
    ...
    return (
        <>
            <header className="w-full flex justify-between h-[80px] items-center mb-4">
                <div className="header-left cursor-pointer" onClick={() => handleNavigate('/')}>
                    <svg xmlns="http://www.w3.org/2000/svg" className="text-neutral-400" width="52" height="52" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" ><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M19 4v16h-12a2 2 0 0 1 -2 -2v-12a2 2 0 0 1 2 -2h12z" /><path d="M19 16h-12a2 2 0 0 0 -2 2" /><path d="M9 8h6" /></svg>
                </div>
                <div className="header-right h-full flex justify-around items-center gap-12">
                    <div className="font-family">
                        <select value={selectedFont} onChange={handleChange} className="bg-white py-y px-4 pr-8 leading-tight focus:outline-none cursor-pointer border-none">
                    ...
                    <div className="color-theme h-full flex justify-around items-center gap-2">
